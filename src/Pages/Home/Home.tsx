...
gsap.to(".wheel", {
   ...
   useEffect(()=>{
     if(pathname == '/') document.body.style.background = '#fffffa'
   },[])
    ...
    <section id='home'>
       <header id="header">
           <div className="header_logo">
               <h2>
                   <span className="_block">BlinkCv</span>
                   <span className="_block s-2">Resume Maker</span>
               </h2>
           </div>

          <a href='https://github.com/TaufeeqRiyaz/resume-maker'> <div className="star">
...
<div className="footer">Made with 💻 and 💙 in BLR</div>
